      ...
      <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="collapsebooksmgmt" data-bs-parent="#accordionSidebar">
                <ul class="navbar-nav ps-3">
                  <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL ?>books/add.php"><i class="fa-solid fa-plus me-2"></i> Add Book </a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="studentsmgmt" data-bs-parent="#accordionSidebar">
                <ul class="navbar-nav ps-3">
                  <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL ?>students/add"><i class="fa-solid fa-plus me-2"></i> Add Student </a></li>
                  <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL ?>students"><i class="fa-solid fa-list me-2"></i> Manage ALL </a></li>
                </ul>
              </div>
            </li>
            <!-- Books Loan -->
